    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
            <li class="nav-item active">
                <a class="nav-link" href="search.php"> Search Donor <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item active">
                <a class="nav-link" href="seeker.php">Profile <span class="sr-only">(current)</span></a>
            </li>
                <li class="nav-item active" style="text-align: right" >
                <a class="nav-link" href="request.php"><i class="fa fa-sign-out" aria-hidden="true"></i>Request List</a>
            </li>
            <li class="nav-item active" style="text-align: right">
