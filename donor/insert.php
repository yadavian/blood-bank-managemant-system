            ...
            <div class="row">
                ...
                <div class="col-md-9 register-right">
                    <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="home-tab" data-toggle="tab" href="donor/insert.php" role="tab" aria-controls="home" aria-selected="true">Donor</a>
                        </li>
                    </ul>
...
if (isset($_POST['insert'])) {
    ...
    if ($data) {
        ...
        echo '</script>';
        echo '<script type="text/javascript">
           window.location = "http://localhost/bloodbankmanagementsystem/donor/login.php"
      </script>';
    } else {
        echo '<script type="text/javascript">';
        echo ' alert("Wrong ")';
