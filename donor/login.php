        ...
        <div class="row">
            <div class="col-md-6 login-form-1">
                ...
                <form method="post">
                    ...
                    <div class="form-group">
                        <a class="ForgetPwd" href="insert.php">Register</a><br>
...
if (isset($_POST['login'])) {
   // echo "clicked";
    $query = "SELECT * FROM `donor` WHERE `email`='" . $_POST['email'] . "' and `password`='" . $_POST['password'] . "'";
    $data = mysqli_query($conn, $query);
    $res = mysqli_fetch_array($data);
    $total = mysqli_num_rows($data);
    if ($total == 1) {
        $_SESSION['email'] = $_POST['email'];
        $_SESSION['did'] = $res['did'];
        header('location:donor.php');
    } else {
        echo '<script type="text/javascript">';
        echo ' alert("Wrong Donor Id And Password")';  //not showing an alert box.
        echo '</script>';
    }
}
?>
