...
<?php include 'C:/xampp/htdocs/BloodBankManagementSystem/donornavbar.php';?><br><br>
            ...
            <div class="col-lg-8 m-auto">
                <form method="post">
                    ...
                    <div class="card-header bg-dark">
                        ...
                        <br>
                        <label> did</label>
                        <input type="text" name="did" value="<?php echo $res['did'];  ?>" class="form-control" required="required" disabled> <br>
...
if (isset($_POST['update'])) {
    ...
    $query = "UPDATE `donor` SET `password` = '" . $_POST['password'] . "',`phone` = '" . $_POST['phone'] . "',`name` = '" . $_POST['name'] . "',`gender` = '" . $_POST['gender'] . "',`blood` = '" . $_POST['blood'] . "',`dob` = '" . $_POST['dob'] . "',`city` = '" . $_POST['city'] . "',`state` = '" . $_POST['state'] . "', `question` = '" . $_POST['question'] . "' WHERE `donor`.`did` = '" . $_REQUEST['did'] . "'";
    ...
    if ($data) {
        ...
        echo '</script>';
        echo '<script type="text/javascript">
           window.location = "http://localhost/bloodbankmanagementsystem/donor/donor.php"
      </script>';
    } else {
        echo '<script type="text/javascript">';
        echo ' alert("Wrong ")';
