...
if (isset($_POST['insert'])) {
    ...
    $folder = "seeker/" . $fileName;
    echo $folder;
    move_uploaded_file($tempName, $folder);

    $query = "INSERT INTO `seeker` (`email`, `password`, `phone`, `name`, `gender`, `blood`, `dob`, `city`, `state`, `picture`, `question`) VALUES ('" . $_POST['email'] . "', '" . $_POST['password'] . "', '" . $_POST['phone'] . "', '" . $_POST['name'] . "', '" . $_POST['gender'] . "', '" . $_POST['blood'] . "', '" . $_POST['dob'] . "', '" . $_POST['city'] . "', '" . $_POST['state'] . "', '$folder', '" . $_POST['question'] . "')";

    $data = mysqli_query($conn, $query);
    if ($data) {
        echo '<script type="text/javascript">';
        echo ' alert("Seeker Data Inserted  ")';
        echo '</script>';
        echo '<script type="text/javascript">
