            ...
            <div class="row">
                <div class="col-md-6 login-form-1">
                    ...
                    <form method="post">
                        ...
                        <div class="form-group">
                            <a href="insert.php" class="ForgetPwd">Register</a><br>
...
if (isset($_POST['login'])) {
    // echo "clicked";
    $query = "SELECT * FROM `seeker` WHERE `email`='" . $_POST['email'] . "' and `password`='" . $_POST['password'] . "'";
    ...
    if ($total == 1) {
        ...
        echo ' alert("Wrong Seeker Id And Password")';  //not showing an alert box.
        echo '</script>';
    }
}
?>